#This is md for Flask_API 
#I took a screenshot when I tested to reach each endpoint and all screenshots are linked here
...
```
![welcome_url](output/Flask_API_welcome.png)
...
def precipitation():
    ...
    return jsonify(dic)
```
![precipitation_url](output/Flask_API_Precipitation.png)
...
```
![precipitation_url](output/Flask_API_stations.png)
...
```
![precipitation_url](output/Flask_API_tobs.png)
...
```
![precipitation_url](output/Flask_API_Start.png)

```python
#set up start and end search
...
```
![precipitation_url](output/Flask_API_Start_End.png)

#write code on how it run
```python
